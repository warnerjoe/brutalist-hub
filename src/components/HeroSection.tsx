      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          <h1 className="text-7xl md:text-9xl font-black uppercase leading-none">
            ...
            <span className="block bg-red-500 text-white px-4 py-2 inline-block transform rotate-2 mt-4 border-4 border-yellow-300 outline outline-4 outline-yellow-300">
